import {
  ...
  CardContainer,
  CardItem,
} from "@/components/global/CardContainer";
...
import { LampComponent } from "@/components/global/LampComponent";
  ...
  return (
    <main>
      ...
      <section className="mt-[-500px]">
        <LampComponent />
        <div className="flex flex-wrap justify-center items-center flex-col md:flex-row gap-8 -mt-72">
